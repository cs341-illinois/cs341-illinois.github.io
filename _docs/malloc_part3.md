...
You recently had to set your own password for your login, so you recall Discreet Drone Services' rules. Each password must be 10 characters, have upper and lowercase characters, digits, and a punctuation character. People don't seem too concerned about security around here; maybe brute-forcing attempts or some smart guessing is possible? You start designing a C program in your head. But you also will try a few obvious guesses that come to mind...
...
Here are some example questions that the team might ask you -
...
6. In case the drone is captured, the security rep wants sensitive data to be erased (overwritten) from heap memory as soon as possible and will ask if this is possible with jq. After doing some research what do you recommend i.e. how should they implement this?

Later, you suddenly understand the fate of Thaddea, you burst into see the CEO's office barely able to speak while you catch your breath...
