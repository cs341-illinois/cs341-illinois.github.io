...
`hexdump` is a command-line utility that displays the raw hexadecimal values of data. By piping your program’s output into `hexdump -C`, you can see exactly what bytes are being written, including non-printable ASCII characters. 
