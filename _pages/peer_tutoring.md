...
From the second week of classes, we hold hybrid peer tutoring sessions. You may join either in-person, in the basement of the Siebel Center for Computer Science or via Zoom. You can join by adding yourself onto the [Queue](https://queue.illinois.edu/q/queue/907) (the schedule can be found below). More detailed instructions are on our [Queue](https://queue.illinois.edu/q/queue/907) page.
...
Prof. Angrave's office hours are listed on the home page. TL;DR Wednesdays 10:10am in the ECEB coffee area, or catch him outside the lecture area immediately after any Mon-Wed-Fri lecture.
